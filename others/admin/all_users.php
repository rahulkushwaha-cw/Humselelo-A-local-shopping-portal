...
?>
                         <center><b>Total <?php echo $countu; ?> registrations till date.</b></center>
        ...
        //$uid = mysql_real_escape_string($_GET['uid']);
            ...
            $squery = mysql_query("SELECT * FROM items WHERE seller_uid='$uuid'");
           ...
           $i++;
                ...
                <td>'.$fb_username.'</td>
                <td>'.$reg_date.'</td>
                <td><a href="deleteseller?uid='.$uuid.'" class="btn btn-danger "><span class="glyphicon glyphicon-trash"></span> Delete</a></td>
            </tr>
